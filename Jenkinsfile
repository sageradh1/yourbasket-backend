...
// /home/ubuntu/importantfiles/static
		   ...
		   stage('Run Image') {
		        steps {
					...
					sh 'sudo docker run -d --add-host=database:172.17.0.1 -v /home/ubuntu/importantfiles:/app/app/static --name yourbasket-webapp-container yourbasket-webapp:1.0.0'
