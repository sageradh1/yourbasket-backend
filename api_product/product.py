...
def index():
    ...
    return make_response(jsonify({"message":"success"},{"product": products}))

########### get products data as per id from database ##############  
@app.route('/products/<id>', methods = ['GET'])
def get_product_by_id(id):
    get_product = Product.query.get(id)
    product_schema = ProductSchema()
    product = product_schema.dump(get_product)
    return make_response(jsonify({"message":"success"},{"product": product}))

########### update products data as per id from database ##############  
...
def update_product_by_id(id):
    ...
    product = product_schema.dump(get_product)
    return make_response(jsonify({"message":"Product updated!"},{"product": product}))

########### delete products data as per id from database ##############  
...
########### create products data in database ##############  
...
def create_product():
    ...
    return make_response(jsonify({"message":"Product inserted!"},{"product": result}),200)
