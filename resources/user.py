...
class UserRegister(Resource):
    ...
    def post(cls):
        ...
        try:
            ...
            traceback.print_exc()
            user.delete_from_db()
            return {"messsage": FAILED_TO_CREATE}, 500
...
class UserLogout(Resource):
    ...
    def post(cls):
        ...
        print(user_username)
        BLACKLIST.add(jti)
        return {"message": _USER_LOGGED_OUT.format(UserModel.find_by_username(user_username).get_full_name())}, 200
...
class TokenRefresh(Resource):
    ...
    def post(cls):
        ...
        user = UserModel.find_by_username(current_user_username)
